...
function(Backbone, SlideWell, OperatingTable, SlideWellSwitch, MarkdownEditor) {
	...
	return Backbone.View.extend({
		...
		render: function() {
			this.$el.html();
			this.$el.append('<div class="top_body"></div>');
			this.$el.append(this._well.render().$el);
			//this.$el.append(new SlideWellSwitch(this._well).render().$el);
			this.$el.append(this._opTable.render().$el.append(new SlideWellSwitch(this._well).render().$el));
			this.$el.append('<div class="right_body"></div>');
			this.$el.append('<div class="bottom_body"></div>');
			return this;
		},
