...
*/
define(['libs/backbone', 'libs/imgup', 'jcrop', './CutImage'],
function(Backbone, Imgup, Jcrop, CutImage) {
	var modalCache = {};
	var reg = /^[a-z]+:/;
	var url;
	...
	var Modal = Backbone.View.extend({
		...
		events: {
			...
			"click img[class='preview']": "_cutImage",
...
//			}
		...
		okClicked: function(e) {
			...
			if (!this.$el.find(".ok").hasClass("disabled")) {
				if(this.options.tag === "img" && this.cutSize){
					this.jcrop_api.destroy();
					console.log(this.cutSize)
					var srcXM = CutImage.cut(this.item, this.cutSize.x, this.cutSize.y, this.cutSize.w, this.cutSize.h);
